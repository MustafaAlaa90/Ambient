...
{
    r.XAxis = readRegister16(ADXL345_REG_DATAX0)+114;
    r.YAxis = readRegister16(ADXL345_REG_DATAY0)+63;
    r.ZAxis = readRegister16(ADXL345_REG_DATAZ0)+873;
    return r;
}
...
void ADXL345::setxyzoffset(Vector offst)
{
    writeRegister8(ADXL345_REG_OFSX, offst.XAxis);
    writeRegister8(ADXL345_REG_OFSY, offst.YAxis);
    writeRegister8(ADXL345_REG_OFSZ, offst.ZAxis);
}