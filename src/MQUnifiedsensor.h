...
{
  public:
    MQUnifiedsensor(String Placa = "Arduino", float Voltage_Resolution =  5, float ADC_Bit_Resolution = 10, int pin = 1, String type = "CUSTOM MQ");
    ...
    void setADC(float value); //For external ADC Usage
